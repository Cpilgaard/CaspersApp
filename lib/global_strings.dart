...
String ditUdbytteText = "\nApp'en henvender sig til alle voksne mennesker, som har lyst til at give sig selv og sin krop en pause fra hverdagens gøremål. Formålet er at have mulighed for at gå ”offline” og dermed lukke af for hverdagens larm, uanset hvor du befinder dig.\n\n" +
    ...
    "Videnskab.dk \n";
String profileText = "\nDenne app tager udgangspunkt i min uddannelse som professions bachelor i afspændingspædagogik og psykomotorik. Afspændingssekvenserne er udarbejdet og inspireret ud fra min erfaring med undervisning inden for afspændings-pædagogikken igennem de sidste 11 år.\n" +
